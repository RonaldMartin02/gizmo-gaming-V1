  ...
  return (
    <div className='About'>
      ...
      <div className='About_div'>
        <div className='About_Ronald'>
          <img className='About_Ronald_img' src={RPortrait} alt="" />
          <div className='About_Ronald_description'>
          <h3 className='About_Ronald_name'>Ronald Martin: Co-Owner</h3>
            <p>Hi My Name is Ronald co-Owner of Gizmo Gaming</p>
            <p>
